        ...
        <div class="row">
            <div class="col-md-7">
                <div class="row group">
                    ...
                    <div class="col-sm-8"> <form:input path="name" class="form-control" required="required" /></div>
                </div>

                <div class="row group">
                    <div class="col-sm-4"><h2 class="h4">Email</h2></div>
                    <div class="col-sm-8"> <form:input path="email" class="form-control" required="required" /></div>
                </div>

                <div class="row group">
                    <div class="col-sm-4"><h2 class="h4">Phone</h2></div>
                    <div class="col-sm-8"> <form:input path="phone" class="form-control" required="required" /></div>
                </div>

                <div class="row group">
                    <div class="col-sm-4"><h2 class="h4">Address</h2></div>
                    <div class="col-sm-8"> <form:input path="address" class="form-control" required="required" /></div>
                </div>
            ...
            <div class="col-sm-12 white">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-md-4">
                        <input type="submit" value="Checkout" class="btn btn-primary pull-right" >
                    </div>
                </div>
                <hr class="offset-md">
            </div>
